...
## Como Alimentar os Dados (Bootstrap)
...
### Opção B: Pelo Airflow (Recomendado para apresentar)
...
1.  **Orquestrador (Airflow):** http://localhost:8080
    *   Mostre as DAGs agendadas e os logs de execução.
2.  **Consumo e Monitoramento (Streamlit):** http://localhost:8501
